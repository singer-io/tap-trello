...
from tap_trello.streams.abstracts import IncrementalStream
...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_trello.streams.abstracts.get_bookmark", return_value=100)
    ...
    @patch("tap_trello.streams.abstracts.get_bookmark", return_value=300)
